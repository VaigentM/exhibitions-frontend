import "./ExhibitionsFilters.sass"
...
const ExhibitionsFilters = ({refetch}) => {

    const {is_moderator} = useAuth()

    const {status, setStatus, date_start, setDateStart, date_end, setDateEnd, user, setUser} = useExhibitions()
